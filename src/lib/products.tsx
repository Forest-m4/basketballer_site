...
export const products: Product[] = [
  {
    ...
    description: "Кроссовки Air Jordan 5 Retro 'Top 3'  Закругленный носок, плоская резиновая подошва.",
    price: 2499,
    discount: 300,
  ...
  },
  {
    ...
    description: "Футболка Nike НБА Dri-FIT Miami Heat выполнена в стиле джерси City, в которых играет команда.",
    price: 1599,
    discount: 250,
  ...
  },
  {
    ...
    description: " Большая вставка разработана именно для Расса и выделена линиями, придающими такую форму.",
    price: 1699,
    discount: 200,
  ...
  },
  {
    ...
    description: "Футболка Nike НБА NEW YOURK Logo выполнена в стиле City Edition, в которых играет моя команда.",
    price: 2199,
    discount: 250,
  ...
  },
  {
    id: 8,
    title: "Шорты баскетбольные",
    description: "Повседневный стиль сочетается в шортах Jordan Jumpman Air TOP И дарит ощущение свободы.",
    price: 1799,
    discount: 250,
